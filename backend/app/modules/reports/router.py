...
from app.modules.reports.crud import report_job_crud
from app.modules.reports.schemas import ReportJobCreate, ReportJobRead, ReportJobUpdate
from fastapi import APIRouter, Depends, HTTPException, status
from sqlalchemy.ext.asyncio import AsyncSession

report_job_router = APIRouter(prefix="/report-jobs", tags=["Report Jobs"])


@report_job_router.get(
    "/",
