...
from app.modules.curriculums.router.subject_unit import subject_units_router
...
from app.modules.curriculums.schemas.subject_unit import SubjectUnitResponse
...
subjects_router.include_router(subject_units_router)
